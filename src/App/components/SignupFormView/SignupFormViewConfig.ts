    ...
    fields: [
        {
            ...
            id: 'fist-name-input',
            placeholder: 'Георгий',
            dataset: { key: 'model_field', value: 'first_name' },
        },
        {
            title: 'Ваша фамилия:',
            type: 'text',
            id: 'last-name-input',
            placeholder: 'Пупкин',
            dataset: { key: 'model_field', value: 'last_name' },
        },
        {
            ...
            dataset: { key: 'model_field', value: 'nick_name' },
        },
        {
            title: 'E-mail:',
            type: 'email',
        ...
        },
        {
            ...
            placeholder: '*****',
            dataset: { key: 'model_field', value: 'repeat_password' },
        }
    ],
    submit: {
