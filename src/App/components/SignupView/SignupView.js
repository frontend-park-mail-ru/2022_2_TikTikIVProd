...
export default class SignupView extends IComponent {
    ...
    render() {
        ...
        const groupBoxRepeatPassword = createDiv({
            ...
            .appendChildren(repeatPasswordTitle, repeatPasswordInput);
        // First name
        ...
        const groupBoxFirstName = createDiv({
            ...
            .appendChildren(firstNameTitle, firstNameInput);
        // Last name
        ...
        const groupBoxLastName = createDiv({
            ...
            .appendChildren(lastNameTitle, lastNameInput);
        //btn submit 
        ...
        const form = createForm({
            ...
            .appendChildren(formHeader, groupBoxFirstName, groupBoxLastName, groupBoxEmail, groupBoxPassword, groupBoxRepeatPassword, submitBtn, formFooter);
